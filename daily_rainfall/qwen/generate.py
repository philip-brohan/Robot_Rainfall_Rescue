...
# outputs = generate_output(model, loader, device, processor)
outputs = evaluate_loss(model, loader, device, processor)
# print(f"Generation {clargs.validation_group} = {outputs}")
