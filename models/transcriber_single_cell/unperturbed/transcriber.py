...
# Transcriber for unperturbed single-cell images.
...
nTrainingImages = 900  # Max is 9000
...
imageData = getImageDataset(
    purpose="training", subdir="unperturbed", nImages=nTrainingImages
).repeat()
...
testImageData = getImageDataset(
    purpose="test", subdir="unperturbed", nImages=nTestImages
).repeat()
