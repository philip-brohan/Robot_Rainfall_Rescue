...
class transcriberModel(tf.keras.Model):
    def __init__(self):
        ...
        self.conv1A = tf.keras.layers.Conv2D(
            ...
            bias_regularizer=tf.keras.regularizers.l2(0.00),
        )
        ...
        # self.norm1F = tf.keras.layers.BatchNormalization()
        ...
        self.map_to_op = tf.keras.layers.Dense(
            436 * 10, activation='elu'
        )
        #self.dense2 = tf.keras.layers.Dense(436 * 10, activation='elu')
        #self.dense3 = tf.keras.layers.Dense(436 * 10, activation='elu')
