...
# Same as the autoencoder, but saves tensorboard profile information
...
class CustomSaver(tf.keras.callbacks.Callback):
    def on_epoch_end(self, epoch, logs={}):
        save_dir = (
            "%s/ML_ten_year_rainfall/fake/random_plain/autoencoder/" + "Epoch_%04d"
...
logs = "%s/ML_ten_year_rainfall/fake/random_plain/autoencoder/logs/" % os.getenv(
    "SCRATCH"
)
